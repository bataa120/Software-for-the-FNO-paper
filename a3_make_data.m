clear;close all;
load('uvzu10v10t1t100_115_mean.mat')
...
for k=1:s:l
    ...
    if k+t-1<=l
        ...
        au(count,4,:,:,:) = permute(t1_d(k:k+t-1,:,:),[2 3 1]);
        au(count,5,:,:,:) = permute(t100_d(k:k+t-1,:,:),[2 3 1]);
        au(count,6,:,:,:) = permute(u10(k:k+t-1,:,:),[2 3 1]);
        au(count,7,:,:,:) = permute(v10(k:k+t-1,:,:),[2 3 1]);        
        count=count+1;
    end
...
save 'uvzu10v10t1t100_115_s5_t25_p.mat' au
